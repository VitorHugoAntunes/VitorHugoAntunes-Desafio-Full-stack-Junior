...
import { ListTodo, LogOut, X } from "lucide-react";
...
export default function MobileSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 h-screen bg-white border-r border-gray-200 flex flex-col z-40 transition-transform duration-300 ${SIDEBAR_WIDTH_CLASS}`}
        style={{
      ...
      >
        <div className="flex flex-col h-full justify-between">
          <div className="p-4 py-6 md:p-6 border-b border-gray-200 flex items-center gap-3">
